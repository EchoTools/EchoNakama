...
func TestNewXPlatformId(t *testing.T) {
	...
	xpi := NewEchoUserId(platformCode, accountId)
...
func TestXPlatformID_Valid(t *testing.T) {
	xpi := &EchoUserId{PlatformCode: STM, AccountId: 12345}
...
func TestXPlatformID_Parse(t *testing.T) {
	tests := []struct {
		s           string
		expectedID  *EchoUserId
		expectedErr error
	}{
		{"STM-12345", &EchoUserId{PlatformCode: STM, AccountId: 12345}, nil},
		{"PSN-67890", &EchoUserId{PlatformCode: PSN, AccountId: 67890}, nil},
		{"XBX-54321", &EchoUserId{PlatformCode: XBX, AccountId: 54321}, nil},
		{"OVR_ORG-98765", &EchoUserId{PlatformCode: OVR_ORG, AccountId: 98765}, nil},
		{"OVR-24680", &EchoUserId{PlatformCode: OVR, AccountId: 24680}, nil},
		{"BOT-13579", &EchoUserId{PlatformCode: BOT, AccountId: 13579}, nil},
		{"DMO-86420", &EchoUserId{PlatformCode: DMO, AccountId: 86420}, nil},
		{"TEN-97531", &EchoUserId{PlatformCode: TEN, AccountId: 97531}, nil},
