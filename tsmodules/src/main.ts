...
let EchoRelaygetAccount = function (ctx: nkruntime.Context, logger: nkruntime.Logger, nk: nkruntime.Nakama, userId: string) {
...
let echoRelaySetAccountRpc: nkruntime.RpcFunction =
  function (ctx: nkruntime.Context, logger: nkruntime.Logger, nk: nkruntime.Nakama, payload: string) {
    ...
    let newObjects: nkruntime.StorageWriteRequest[] = [
      { collection: 'relayConfig', key: 'authSecrets', userId, value: authSecrets, permissionRead: 2, permissionWrite: 1 },
